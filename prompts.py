...
ENTITY_EXTRACTION_PROMPT = PromptTemplate(
    ...
    Make sure each item in the list of entities and relations refers to only one entity or relation in the singular form without any adjective prefixes or explanations.
    It is very important that there are no duplicate entities or relations in your final list of entities and relations.
    Be thorough in your extraction of entities and relations and do not miss any. Extract all entities and relations that are mentioned in the text.
    Do not add any additional information that is not explicitly provided in the text.
